...
public static class TuningPresetCatalog
{
    ...
    [
        new TuningPresetDefinition
        {
            ...
            AnchorLookaheadPassRatio = 1.00,
            AnchorLookaheadDropTolerance = 0.00,
            ContinuationLookaheadPassRatio = 1.00,
            ContinuationLookaheadDropTolerance = 0.00,
        ...
        new TuningPresetDefinition
        {
            ...
            ContinuationLookaheadDepth = 6,
            ContinuationThresholdMargin = 0.00,
            ...
            UseMicrosegmentSimilarity = true,
            MicrosegmentCount = 4,
            MicrosegmentPenaltyStartThreshold = 0.74,
            MicrosegmentRejectionThreshold = 0.54,
            MicrosegmentPenaltyStrength = 0.12
        },
        new TuningPresetDefinition
        {
            Id = WildId,
            ...
            UseMicrosegmentSimilarity = true,
            MicrosegmentCount = 3,
            MicrosegmentPenaltyStartThreshold = 0.65,
            MicrosegmentRejectionThreshold = 0.42,
            MicrosegmentPenaltyStrength = 0.075
        }
    ];
