...
public static class AiModelDefaultValues
{
    ...
    public const string DiscogsEffNetInputName = "melspectrogram";
    public const string DiscogsEffNetEmbeddingOutputName = "embeddings";
    ...
    public const int DiscogsEffNetEmbeddingDimensions = 512;
